...
@borg.on(VAMPBOT_cmd(pattern="stupid$"))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(VAMPBOT_cmd(pattern=f"bombs$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(VAMPBOT_cmd(pattern="wtf$"))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(VAMPBOT_cmd(pattern="ding$"))
async def _(event):
    ...
    animation_chars = [
        ...
        "⬜⬜⬛⬜⬜\n⬜⬛⬜⬜⬜\n🔴⬜⬜⬜⬜",
        "🔴⬛⬛⬜⬜\n⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜",
        "⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜\n⬜  [VAMPBOT_ IS BEST](https://github.com/D15H4NT0P/VAMPUSERBOT) ⬜\n⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜",
    ]
    if event.fwd_from:
        return
...
@borg.on(VAMPBOT_cmd(pattern=f"hypno$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@borg.on(VAMPBOT_cmd(pattern="gangasta$"))
async def _(event):
...
@borg.on(VAMPBOT_cmd(pattern=f"charging$"))
