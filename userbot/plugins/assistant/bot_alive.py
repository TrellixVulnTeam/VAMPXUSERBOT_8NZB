...
pm_caption += "► **License** : [GNU General Public License v3.0](https://github.com/D15H4NT0P/VAMPUSERBOT/blob/master/LICENSE)\n"
pm_caption += "► **Copyright** : [Black Lighting](GitHub.com/D15H4NT0P/VAMPUSERBOT)\n"
light = [[Button.url("✧Repos✧", "https://github.com/D15H4NT0P/VAMPUSERBOT"), Button.url("✧Support✧", "https://t.me/VAMPBOT_support")]]
