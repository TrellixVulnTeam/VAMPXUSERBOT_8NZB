...
@borg.on(VAMPBOT_cmd(outgoing=True, pattern="trump ?(.*)"))
...
@borg.on(VAMPBOT_cmd(outgoing=True, pattern="johnny ?(.*)"))
...
@borg.on(VAMPBOT_cmd(outgoing=True, pattern="bhau ?(.*)"))
...
@borg.on(VAMPBOT_cmd(outgoing=True, pattern="sunny ?(.*)"))
...
@borg.on(VAMPBOT_cmd(outgoing=True, pattern="joker ?(.*)"))
async def j(event):
    text = event.pattern_match.group(1)
    text = re.sub("&", "", text)
    reply_to_id = event.message
...
@borg.on(VAMPBOT_cmd(outgoing=True, pattern="modi ?(.*)"))
...
@borg.on(VAMPBOT_cmd(outgoing=True, pattern="mia ?(.*)"))
async def mia(event):
    text = event.pattern_match.group(1)
    text = re.sub("&", "", text)
    reply_to_id = event.message
...
@borg.on(VAMPBOT_cmd(outgoing=True, pattern="cmm ?(.*)"))
async def cmm(event):
    text = event.pattern_match.group(1)
    text = re.sub("&", "", text)
    reply_to_id = event.message
...
@borg.on(VAMPBOT_cmd(outgoing=True, pattern="type ?(.*)"))
...
@borg.on(VAMPBOT_cmd(outgoing=True, pattern="waifu ?(.*)"))
...
@borg.on(VAMPBOT_cmd(outgoing=True, pattern="tweet ?(.*)"))
...
@borg.on(VAMPBOT_cmd(pattern="tweetme(?: |$)(.*)"))
