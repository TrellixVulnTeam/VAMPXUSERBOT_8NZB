...
from userbot.utils import VAMPBOT_cmd, edit_or_reply, errors_handler, sudo_cmd
...
@bot.on(VAMPBOT_cmd(outgoing=True, pattern="climate( (.*)|$)"))
...
@bot.on(VAMPBOT_cmd(outgoing=True, pattern="setcity(?: |$)(.*)"))
...
@bot.on(VAMPBOT_cmd(pattern="wttr ?(.*)"))
