...
@borg.on(VAMPBOT_cmd(pattern="cri", outgoing=True))
async def cri(e):
...
@borg.on(VAMPBOT_cmd(pattern="insut", outgoing=True))
async def cry(e):
    """ y u du dis, i cry everytime !! """
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
...
@borg.on(VAMPBOT_cmd(pattern="cp(?: |$)(.*)", outgoing=True))
...
@borg.on(VAMPBOT_cmd(pattern="vapor(?: |$)(.*)", outgoing=True))
async def vapor(vpr):
    """ Vaporize everything! """
...
@borg.on(VAMPBOT_cmd(pattern="str(?: |$)(.*)", outgoing=True))
...
@borg.on(VAMPBOT_cmd(pattern="izal(?: |$)(.*)", outgoing=True))
async def izal(zgfy):
...
@borg.on(VAMPBOT_cmd(pattern="hi", outgoing=True))
async def hoi(hello):
    """ Greet everyone! """
...
@borg.on(VAMPBOT_cmd(pattern="irand", outgoing=True))
...
@borg.on(VAMPBOT_cmd(pattern="owo(?: |$)(.*)", outgoing=True))
async def faces(owo):
    """ UwU """
...
@borg.on(VAMPBOT_cmd(pattern="shrug", outgoing=True))
...
@borg.on(VAMPBOT_cmd(pattern="roon", outgoing=True))
...
@borg.on(VAMPBOT_cmd(pattern="disable roon", outgoing=True))
...
@borg.on(VAMPBOT_cmd(pattern="enable roon", outgoing=True))
...
@borg.on(VAMPBOT_cmd(pattern="10iq", outgoing=True))
async def iqless(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("♿")


@borg.on(VAMPBOT_cmd(pattern="mock(?: |$)(.*)", outgoing=True))
...
@borg.on(VAMPBOT_cmd(pattern="clap(?: |$)(.*)", outgoing=True))
...
@borg.on(VAMPBOT_cmd(pattern="bt", outgoing=True))
...
@borg.on(VAMPBOT_cmd(pattern="smk (.*)", outgoing=True))
async def smrk(smk):
...
@borg.on(VAMPBOT_cmd(pattern="f (.*)", outgoing=True))
async def payf(e):
...
@borg.on(VAMPBOT_cmd(pattern="lgfy (.*)", outgoing=True))
