...
@borg.on(VAMPBOT_cmd(pattern="sin ?(.*)"))
...
@borg.on(VAMPBOT_cmd(pattern="cos ?(.*)"))
...
@borg.on(VAMPBOT_cmd(pattern="tan ?(.*)"))
...
@borg.on(VAMPBOT_cmd(pattern="cosec ?(.*)"))
...
@borg.on(VAMPBOT_cmd(pattern="sec ?(.*)"))
...
@borg.on(VAMPBOT_cmd(pattern="cot ?(.*)"))
...
@borg.on(VAMPBOT_cmd(pattern="sqnum ?(.*)"))
...
@borg.on(VAMPBOT_cmd(pattern="cube?(.*)"))
