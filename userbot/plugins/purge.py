...
from userbot.utils import VAMPBOT_cmd, errors_handler


# @register(outgoing=True, pattern="^.purge$")
@borg.on(VAMPBOT_cmd(pattern=r"purge"))
@errors_handler
...
@borg.on(VAMPBOT_cmd(pattern=r"purgeme"))
@errors_handler
...
@borg.on(VAMPBOT_cmd(pattern=r"del"))
@errors_handler
...
@borg.on(VAMPBOT_cmd(pattern=r"edit"))
@errors_handler
...
@borg.on(VAMPBOT_cmd(pattern=r"sd"))
@errors_handler
