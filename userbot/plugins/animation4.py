...
@borg.on(VAMPBOT_cmd(pattern=f"snake$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(VAMPBOT_cmd(pattern=f"mc$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@borg.on(VAMPBOT_cmd(pattern="virus$"))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(VAMPBOT_cmd(pattern=r"repe$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(VAMPBOT_cmd(pattern=f"isro$"))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
...
@borg.on(VAMPBOT_cmd(pattern=f"nakal$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.5
...
@borg.on(VAMPBOT_cmd(pattern=r"hbday"))
async def hi(event):
    if event.fwd_from:
        return
    await event.edit(
