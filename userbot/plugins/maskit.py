...
@borg.on(VAMPBOT_cmd(pattern=r".cmask"))
...
@borg.on(VAMPBOT_cmd(pattern=r".ppro"))
async def scan(event):
    path = "dcobra"
...
@borg.on(VAMPBOT_cmd(pattern=r".oxy"))
async def scan(event):
    path = "dcobra"
...
@borg.on(VAMPBOT_cmd(pattern=r".gold"))
async def scan(event):
    path = "dcobra"
...
@borg.on(VAMPBOT_cmd(pattern=r".old"))
async def scan(event):
    path = "dcobra"
...
@borg.on(VAMPBOT_cmd(pattern=r".krish"))
async def scan(event):
    path = "dcobra"
...
@borg.on(VAMPBOT_cmd(pattern=r".cprotect"))
async def scan(event):
    path = "dcobra"
