...
pm_caption += "➥ **License** : [GNU General Public License v3.0](https://github.com/Anmol-dot283/VAMPUSERBOT)\n"
pm_caption += "➥ **Copyright** : By [D15H4NT0P@Github](GitHub.com/StarkGang)\n"
pm_caption += "➥ **Check Stats By Doing** `.stat`. \n\n"
pm_caption += "[🇮🇳 Deploy 𝔅𝔩𝔞𝔠𝔨 𝔏𝔦𝔤𝔥𝔱𝔫𝔦𝔫𝔤Userbot 🇮🇳](https://telegra.ph/FRIDAY-06-15)"


@borg.on(VAMPBOT_cmd(pattern=r"fralive"))
