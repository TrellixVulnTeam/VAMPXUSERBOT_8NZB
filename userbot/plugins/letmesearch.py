...
@borg.on(VAMPBOT_cmd(pattern="lmg (.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(VAMPBOT_cmd(pattern="lmy (.*)"))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@borg.on(VAMPBOT_cmd(pattern="ddg (.*)"))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@borg.on(VAMPBOT_cmd(pattern="lmalt (.*)"))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@borg.on(VAMPBOT_cmd(pattern="lmvar (.*)"))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@borg.on(VAMPBOT_cmd(pattern="lmlog (.*)"))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@borg.on(VAMPBOT_cmd(pattern="dyno(.*)"))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@borg.on(VAMPBOT_cmd(pattern="lmkp (.*)"))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@borg.on(VAMPBOT_cmd(pattern="gem (.*)"))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@borg.on(VAMPBOT_cmd(pattern="archive (.*)"))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
