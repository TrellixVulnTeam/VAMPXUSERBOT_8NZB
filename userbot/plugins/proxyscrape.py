...
@borg.on(VAMPBOT_cmd(pattern="http$"))
...
@borg.on(VAMPBOT_cmd(pattern="socks4$"))
@borg.on(VAMPBOT_cmd(pattern="socks4$", allow_sudo=True))
...
@borg.on(VAMPBOT_cmd(pattern="socks5$"))
@borg.on(VAMPBOT_cmd(pattern="socks5$", allow_sudo=True))
