...
#Import Gudz
RUN wget https://raw.githubusercontent.com/D15H4NT0P/VAMPUSERBOT/master/VAMPBOT_run.py
RUN wget https://raw.githubusercontent.com/D15H4NT0P/VAMPUSERBOT/master/requirements.txt
#Start Fumkin
